...
parser.add_argument('--nepoch', default=5000, type=int, help='Number of Training epochs')
parser.add_argument('--lr', default=1e-4, type=float, help='Initial learning rate')
parser.add_argument('--batch', default=16, type=int, help='Train batch size')
parser.add_argument('--mag', default=4, type=int, help='Upscaling factor (choices: 4,8)')

parser.add_argument('--rcrop_sz', default=160, type=int, help='Target size for randomly cropping the input image')
...
parser.add_argument('--save_model_name', default='ABPN_v5_LaUD', help='Name for trained model')
...
parser.add_argument('--seed', default=123, type=int, help='Manual Seed Number')
...
#===============================================================================================================================
model = ABPNv5_LaUD(input_dim=3, dim=48)
...
lr_schedule = list(map(int, args.nepoch * np.array([0.5])))
...
trainset = train_dataset(mode='train', root_path=args.train_dir,
                         ...
                         is_rrot=False, rand_hori_flip=True, rand_vert_flip=True, rgb_shuffle=False, grayscale=False, norm=False)
