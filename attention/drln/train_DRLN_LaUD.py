...
parser.add_argument('--save_model_name', default='DRLN_LaUD', help='Name for trained model')
...
#===============================================================================================================================
model = DRLN_LaUD(scale=args.mag)
    ...
    if (epoch+1) % args.test_epoch == 0:
        ...
        with torch.no_grad():
            ...
            for titeration, tdata in enumerate(testloader):
                ...
                psnr_sum += cal_psnr(thr_img, tsr_lst[-1], crop_border=args.mag, minmax='0_1', clamp=True, gray_scale=True, ver='YCrCb_BT601')
                ssim_sum += cal_ssim(thr_img, tsr_lst[-1], crop_border=args.mag, minmax='0_1', filter_size=11, filter_sigma=1.5, clamp=True, grayscale=True, ver='YCrCb_BT601')
