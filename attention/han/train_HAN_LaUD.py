...
parser.add_argument('--nepoch', default=400, type=int, help='Number of Training epochs')
...
parser.add_argument('--rcrop_sz', default=96, type=int, help='Random crop size of image')
...
parser.add_argument('--pretrain', default='./Models/RCAN_BIX2.pt', help='Path for pretrained RCAN model')
...
parser.add_argument('--save_model_name', default='HAN_LaUD', help='Name for trained model')
parser.add_argument('--print_iter', default=200, type=int, help='Interval of iterations to print training information')
...
#===============================================================================================================================
model = HAN_LaUD(reduction=16, scale=args.mag)
...
trainset = train_dataset(mode='train', root_path=args.train_dir,
                         ...
                         is_rrot=True, rand_hori_flip=True, rand_vert_flip=True, rgb_shuffle=False, grayscale=False)
...
for epoch in range(args.nepoch):
    ...
    for iteration, data in enumerate(trainloader):
        ...
        loss_det = criterion(det, det_img)
    ...
    if (epoch+1) % args.test_epoch == 0:
        ...
        with torch.no_grad():
            ...
            for titeration, tdata in enumerate(testloader):
                ...
                tsr, tdet = model(tlr_img)

                psnr_sum += cal_psnr(thr_img, tsr, crop_border=args.mag, minmax='0_255', clamp=True, gray_scale=True, ver='YCrCb_BT601')
                ssim_sum += cal_ssim(thr_img, tsr, crop_border=args.mag, minmax='0_255', filter_size=11, filter_sigma=1.5, clamp=True, grayscale=True, ver='YCrCb_BT601')
