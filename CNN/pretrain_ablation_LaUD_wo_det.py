...
parser.add_argument('--save_model_name', default='LaUD_wo_det_pret', help='Name for trained model')
...
#===============================================================================================================================
model = LaUD_wo_det(rudp=args.RUDP, scale=args.mag, ch=64)
...
for epoch in range(args.nepoch):
    ...
    for iteration, data in enumerate(trainloader):
        ...
        if args.loss_weighted_sum:
            loss = lst_loss(sr_lst, hr_img, args.alpha, loss_fct_sr=criterion)
        else:
            loss = criterion(sr_lst[-1], hr_img)
