...
#Modified model
#===============================================================================================================================
class HAN_LaUD(nn.Module):
    def __init__(self, reduction=16, scale=2, conv=default_conv):
        super(HAN_LaUD, self).__init__()
        ...
        self.tail_det = nn.Sequential(*modules_tail_det)
